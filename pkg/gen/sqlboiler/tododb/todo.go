...
var TodoWhere = struct {
	...
	Name:        whereHelperstring{field: "\"todo\".\"name\""},
...
var (
	todoAllColumns            = []string{"id", "name", "description"}
	todoColumnsWithoutDefault = []string{"name", "description"}
...
func (q todoQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Todo, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "tododb: failed to execute a one query for todo")
	}
...
func (q todoQuery) All(ctx context.Context, exec boil.ContextExecutor) (TodoSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "tododb: failed to assign all query results to Todo slice")
	}
...
func (q todoQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "tododb: failed to count todo rows")
	}
...
func (q todoQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "tododb: failed to check if todo exists")
	}
...
func FindTodo(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Todo, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "tododb: unable to select from todo")
	}
...
func (o *Todo) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("tododb: no todo provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "tododb: unable to insert into todo")
	}
...
func (o *Todo) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("tododb: unable to update todo, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "tododb: unable to update todo row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tododb: failed to get rows affected by update for todo")
	}
...
func (q todoQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "tododb: unable to update all for todo")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tododb: unable to retrieve rows affected for todo")
	}
...
func (o TodoSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("tododb: update all requires at least one column argument")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "tododb: unable to update all in todo slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tododb: unable to retrieve rows affected all in update all todo")
	}
	return rowsAff, nil
}
...
func (o *Todo) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("tododb: no todo provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("tododb: unable to upsert todo, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "tododb: unable to upsert todo")
	}
...
func (o *Todo) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("tododb: no Todo provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "tododb: unable to delete from todo")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tododb: failed to get rows affected by delete for todo")
	}
...
func (q todoQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("tododb: no todoQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "tododb: unable to delete all from todo")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tododb: failed to get rows affected by deleteall for todo")
	}
...
func (o TodoSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "tododb: unable to delete all from todo slice")
	}
...
func (o *TodoSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "tododb: unable to reload all in TodoSlice")
	}
...
func TodoExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "tododb: unable to check if todo exists")
	}
